...
@section('body')
    ...
    <main>
        ...
        <section class="bg-white mt-24">
            <div class="w-full sm:w-10/12 lg:w-5/12 px-4 mx-auto text-center">
                <h2 class="font-sans text-3xl font-bold text-gray-500 pt-5  lg:leading-normal">{{$announcement['name']}}</h2>
                <div class="bg-yellow-600 w-52 mt-2 rounded-xl mx-auto h-2 "></div>
            </div>
            <div class="px-4">
                <p class="py-10 leading-loose">
                   {!!$announcement['content']!!}
                </p>
            </div>
        </section>

        <section class="py-8 px-4 mx-auto max-w-screen-xl sm:px-20 lg:py-16 lg:px-6 overflow-hidden">
            <table class="table-auto min-w-full text-left">
                ...
                <tr>
                    ...
                    <th class="px-6 py-4">Sebagai</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td class="px-6 py-4">1</td>
                    <td class="px-6 py-4">Daviatul Umam</td>
                    <td class="px-6 py-4">Megaremmeng</td>
                    <td class="px-6 py-4">Juara 1</td>
                </tr>
                </tbody>
            </table>
        </section>
