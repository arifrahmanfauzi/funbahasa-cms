    ...
    <main>
        <div>
            @foreach ($categories as $category)
                <div class="container mx-auto pt-28 xl:pt-36 lg:pt-32 px-10 xl:px-16 lg:px-16 md:px-10">
                    ...
                    <div class="mt-8 grid grid-cols-1 xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-6">
                        @foreach ($category->karya as $karya)
            ...
            <div class="container mx-auto pt-28 xl:pt-36 lg:pt-32 px-10 xl:px-16 lg:px-16 md:px-10" x-data="loadPuisi()">
                <div class="border-b xl:border-none lg:border-none md:border-none">
                    <a href="kategori-puisi.html"
                        class="font-title font-extrabold xl:pb-3 text-2xl xl:text-4xl lg:text-3xl text-gray-500 hover:text-blue-500">Puisi</a>
                    <p class="sub-category font-sans font-medium pb-3 text-sm text-gray-500 ">Temukan berbagai karya sastra
                        dengan irama, lirik, rima, dan ritme pada setiap barisnya</p>
                </div>
                <div class="mt-8 grid grid-cols-1 xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    <template x-for="item in filteredData" :key="item">
                        <div class="h-full flex items-start rounded-xl shadow-xl transform hover:scale-105"
                            ...
                            <a href="puisi.html">
                                <div class="flex-grow px-6 py-5">
                                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-500 mb-1 font-sans"
                                        x-text="item.category"></h2>
                                    <h1 class="title-font text-base xl:text-lg font-medium text-gray-500 mb-3 font-title font-bold"
                                        x-text="item.title"></h1>
                                    <p class="content leading-relaxed mb-5 font-sans xl:text-sm lg:text-sm md:text-xs text-gray-500 "
                                        x-text="item.content"></p>
                                    <a class="inline-flex items-center">
                                        <img alt="blog" :src="`${item.profile_image}`"
                                            class="w-8 h-8 rounded-full flex-shrink-0 object-cover object-center">
                                        <span class="flex flex-grow pl-3">
                                            <span class="title-font font-medium text-gray-500 font-sans text-xs xl:text-sm"
                                                x-text="item.author"></span>
                                        </span>
                                    </a>
                                </div>
                            </a>
            ...
            <div class="container mx-auto pt-12 px-10 xl:px-16 lg:px-16 md:px-10" x-data="loadCerpen()">
                <div class="border-b xl:border-none lg:border-none md:border-none">
                    <a href="kategori-cerpen.html"
                        class="font-title font-extrabold xl:pb-3 text-2xl xl:text-4xl lg:text-3xl text-gray-500 hover:text-blue-500">Cerpen</a>
                    <p class="sub-category font-sans font-medium pb-3 text-sm text-gray-500 ">Temukan berbagai prosa fiksi
                        yang
                        dikemas secara menarik</p>
                </div>
                <div class="mt-8 grid grid-cols-1 xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    <template x-for="item in filteredData" :key="item">
                        <div class="h-full flex items-start rounded-xl shadow-xl transform hover:scale-105"
                            style="background-color: rgba(211,238,249,255);">
                            <a href="cerpen.html">
                                <div class="flex-grow px-6 py-5">
                                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-500 mb-1 font-sans"
                                        x-text="item.category"></h2>
            ...
            <div class="container mx-auto pt-12 px-10 xl:px-16 lg:px-16 md:px-10" x-data="loadCeritaAnak()">
                <div class="border-b xl:border-none lg:border-none md:border-none">
                    <a href="kategori-cerita-anak.html"
                        class="font-title font-extrabold xl:pb-3 text-2xl xl:text-4xl lg:text-3xl text-gray-500 hover:text-blue-500">Cerita
                        Anak</a>
                    <p class="sub-category font-sans font-medium pb-3 text-sm text-gray-500 ">Temukan berbagai karya sastra
                        prosa yang mengisahkan kehidupan anak-anak</p>
                </div>
                <div class="mt-8 grid grid-cols-1 xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    <template x-for="item in filteredData" :key="item">
                        <div class="h-full flex items-start rounded-xl shadow-xl transform hover:scale-105"
            ...
            <div class="container mx-auto pt-12 px-10 xl:px-16 lg:px-16 md:px-10" x-data="loadArtikel()">
                <div class="border-b xl:border-none lg:border-none md:border-none">
                    <a href="kategori-artikel.html"
                        class="font-title font-extrabold xl:pb-3 text-2xl xl:text-4xl lg:text-3xl text-gray-500 hover:text-blue-500">Artikel</a>
                    <p class="sub-category font-sans font-medium pb-3 text-sm text-gray-500 ">Temukan berbagai karangan
                        aktual
                        dengan persoalan terkini</p>
                </div>
                <div class="mt-8 grid grid-cols-1 xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    <template x-for="item in filteredData" :key="item">
                        <div class="h-full flex items-start rounded-xl shadow-xl transform hover:scale-105"
                            style="background-color: rgba(245, 220, 164,255)">
                            <a href="artikel.html">
                                <div class="flex-grow px-6 py-5">
                                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-500 mb-1 font-sans"
                                        x-text="item.category"></h2>
            ...
            <div class="container mx-auto pt-12 px-10 xl:px-16 lg:px-16 md:px-10" x-data="loadEsai()">
                <div class="border-b xl:border-none lg:border-none md:border-none">
                    <a href="kategori-esai.html"
                        class="font-title font-extrabold xl:pb-3 text-2xl xl:text-4xl lg:text-3xl text-gray-500 hover:text-blue-500">Esai</a>
                    <p class="sub-category font-sans font-medium pb-3 text-sm text-gray-500 ">Temukan karya tulis ilmiah
                        dengan
                        berbagai tema dan sudut pandang</p>
                </div>
                <div class="mt-8 grid grid-cols-1 xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    <template x-for="item in filteredData" :key="item">
                        <div class="h-full flex items-start rounded-xl shadow-xl transform hover:scale-105"
                            style="background-color: rgba(255,213,121,255)">
                            <a href="esai.html">
                                <div class="flex-grow px-6 py-5">
                                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-500 mb-1 font-sans"
                                        x-text="item.category"></h2>
