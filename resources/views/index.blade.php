    ...
    @section('body')
        ...
        <main>
            ...
            <section class="relative w-full xl:pt-13 sm:pt-16 font-title">
                <picture>
                    <source media="(min-width: 640px)" srcset="{{ asset('assets/img/sec-1-2.svg') }}" alt="image-greeting"
                        class="w-full h-auto">
                    <img src="{{ asset('assets/img/sec-1-mob-2.svg') }}"
                        class="mx-auto py-12 xl:py-0 lg:py-0 md:py-0 sm:py-0 w-3/4 xl:w-full lg:w-full md:w-full sm:w-full"
                        alt="image logo mobile">
                </picture>
                <div
                    class="absolute left-16 right-16 xl:right-0 lg:right-0 md:right-0 sm:right-0 xl:top-1/4 sm:top-1/3 md:top-1/4 lg:top-1/4 xl:left-36 sm:left-24 md:left-28 lg:left-32">
            ...
            <section>
                <div
                    class="mt-52 py-10 xl:mt-0 lg:mt-0 md:mt-0 sm:mt-0 xl:pb-8 lg:pb-7 xl:pt-20 sm:py-14 md:py-16 lg:pt-20 bg-blue-100">
                    <div>
                        <h2
                        ...
                        <div
                            class="bg-yellow-600 w-32 xl:w-80 sm:w-40 md:w-64 lg:w-56 mt-0 xl:mt-2 sm:mt-1 rounded-xl mx-auto h-1 xl:h-2 sm:h-1 md:h-1 lg:h-2">
                        </div>
                        <p
                            class="text-gray-500 my-9 xl:my-16 sm:my-10 md:my-12 lg:my-14 mx-5 xl:mx-24 sm:mx-16 md:mx-28 lg:mx-16 text-center font-sans text-xs xl:text-lg sm:text-sm md:text-base lg:text-lg font-thin leading-relaxed xl:leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-relaxed">
                    ...
                    <div class="flex items-center place-content-center">
                        <picture>
                            <source media="(min-width: 1024px)" class="mx-auto w-full xl:h-80 sm:invisible xl:visible"
            ...
            <section>
                ...
                @endempty
                <div
                    class="flex flex-col md:flex-row lg:flex-row w-full my-20 xl:my-32 sm:my-24 px-10 xl:px-36 sm:px-36 md:px-16 lg:px-32">
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/2 h-screen sm:h-screen md:h-auto lg:h-auto xl:h-auto border shadow-lg bg-white rounded-xl xl:bg-cover xl:bg-no-repeat xl:bg-center"
                        style="background-image: url('{{ Storage::disk(config('admiko_config.filesystem'))->url($admiko_data['fileInfo']['poster_image']['original']['folder'] . $event->poster_image) }}');">
                ...
                <div class="slider-wrapper pl-4 xl:px-36 lg:px-32 md:px-28 sm:px-24 pt-8">
                    <div class="slides-container" id="slides-container">
                        <div class="slide">
                            ...
                            <div
                                class="font-sans leading-loose sm:leading-loose md:leading-loose lg:leading-loose xl:leading-loose text-xs xl:text-sm sm:text-xs md:text-xs lg:text-sm font-thin xl:font-regular sm:font-thin md:font-thin lg:font-regular">
                                <p>Syukur tak habisnya kepada Tuhan Yesus karena telah memantaskan saya sebagai Juara 1
                                    Lomba Kreasi Puisi Pendek Nasional 2020 yang diadakan oleh Fun Bahasa.</p>
                                <br>
                                <p>Juga teruntuk Dewan Juri dan Fun Bahasa, terima kasih banyak. Akhirnya “Melukis Wajah
                                    Ibu” menjadi karya pertama saya yang berhasil menjuarai Event Lomba Cipta Puisi
                                    Nasional.</p>
                                <br>
                                <p>Teman-teman yang sempat membaca ini, jangan menyerah untuk melangitkan mimpi yah. Makin
                                    tinggi gunung yang kita daki, makin indah pemandangannya. Ngomong-ngomong selagi masih
                                    #dirumahaja yuk sama-sama berkarya. Dan yang terpenting, jangan behenti menulis.</p>
                            </div>
                            <div class="flex items-center w-10/12 xl:w-3/4 lg:w-3/4 md:w-3/4 sm:w-3/4">
                                <img src="{{ asset('assets/img/org-1.svg') }}"
                                    class="display block mr-5 py-7 rounded-full h-28 sm:h-28 md:h-28 lg:h-32 xl:h-32">
                                <div>
                                    <p class="font-title font-bold text-sm xl:text-base sm:text-sm md:text-sm lg:text-base">
                                        Sevryade Anugrah Sambolangi</p>
                                    <span
                                        class="font-sans font-thin xl:font-regular sm:font-thin md:font-thin lg:font-regular text-xs">Author</span>
                                </div>
                            </div>
                        </div>
                        <div class="slide">
                ...
                <div class="flex justify-end px-7 xl:px-36 lg:px-32 md:px-28 sm:px-24">
                    <div>
                        <button class="slide-arrow" id="slide-arrow-prev">
                            <img src="{{ asset('assets/img/arrow-left.svg') }}" alt="arrow-left"
                                class="w-8 xl:mx-2 lg:mx-2 md:mx-2 sm:mx-1">
                        </button>
                    </div>
                    <div>
            ...
            <section>
                ...
                <div class="post-column my-16 font-title relative">
                    ...
                    <div class="grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-4 gap-7 mb-10 relative">
                        ...
                        <div class="puisi-col1 rounded-xl p-4 text-left transform hover:scale-105 motion-reduce:transform-none"
                            style="background-color: #f0f0f0;">
                            <a href="{{ url('/baca-karya/puisi') }}">
                                <div>
                                    <img src="{{ asset('assets/img/puisi.svg') }}"
                                        class="display block ml-3 mt-3 xl:w-9 md:w-7 lg:w-8 pb-3">
                                    <p class="font-bold font-title ml-3 xl:text-base lg:text-base md:text-sm">Puisi</p>
                                </div>
                            </a>
                        </div>
                        <div class="div-kategori col-span-3 rounded-xl px-7 py-5 xl:text-3xl lg:text-3xl md:text-2xl text-2xl"
                            style="background: #FCB316;">
                        ...
                        <div class="puisi-col2 col-span-3 rounded-xl p-4 text-left transform hover:scale-105 motion-reduce:transform-none"
                            style="background-color: #f0f0f0;">
                            <a href="#">
                                <div class="div-puisi">
                                    <img src="{{ asset('assets/img/puisi.svg') }}"
                                        class="display block ml-3 mt-3 w-8 sm:w-8 pb-3">
                        ...
                        <div class="rounded-xl p-4 text-left transform hover:scale-105 motion-reduce:transform-none"
                            ...
                            <a href="{{ url('/baca-karya/cerpen') }}">
                                <div class="div-cerpen">
                                    <img src="{{ asset('assets/img/cerpen.svg') }}"
                                        class="display block ml-3 mt-3 w-8 xl:w-9 sm:w-8 md:w-7 lg:w-8 pb-3">
                                    <p
                                        class="font-bold font-title ml-3 xl:pb-3 lg:pb-3 md:pb-3 xl:text-base lg:text-base md:text-sm sm:text-base">
                                        Cerpen</p>
                                </div>
                            </a>
                        </div>
                        <div class="rounded-xl p-4 text-left transform hover:scale-105 motion-reduce:transform-none"
                            ...
                            <a href="{{ url('/baca-karya/cerita-anak') }}">
                                <div class="div-cer-anak">
                                    <img src="{{ asset('assets/img/cer-anak.svg') }}"
                                        class="display block ml-3 mt-3 w-8 xl:w-9 sm:w-8 md:w-7 lg:w-8 pb-3">
                                    <p
                                        class="font-bold font-title ml-3 xl:pb-3 lg:pb-3 md:pb-3 xl:text-base lg:text-base md:text-sm sm:text-base">
                                        Cerita Anak</p>
                        ...
                        <div class="rounded-xl p-4 text-left transform hover:scale-105 motion-reduce:transform-none"
                            ...
                            <a href="{{ url('/baca-karya/artikel') }}">
                                <div class="div-artikel">
                                    <img src="{{ asset('assets/img/artikel.svg') }}"
                                        class="display block ml-3 mt-3 w-8 xl:w-9 sm:w-8 md:w-7 lg:w-8 pb-3">
                                    <p
                                        class="font-bold font-title ml-3 xl:pb-3 lg:pb-3 md:pb-3 xl:text-base lg:text-base md:text-sm sm:text-base">
                                        Artikel</p>
